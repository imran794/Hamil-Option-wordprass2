         ...
         <div class="container">
            ...
            <div class="row">
               ...
               while ($query->have_posts()) {
                  $query->the_post();
                  $sub_title = get_field('sub_title');
                  $team_fb   = get_field('team_facebook');
                  $team_tw   = get_field('team_twitter_');
                  $team_link = get_field('team_linkedin');
                  $team_goo  = get_field('team_google');
                  ?>
                     <div class="col-md-4">
                  <div class="single-team">
                     ...
                     <div class="team-hover">
                        <div class="team-content">
                           <h4><?php echo the_title(); ?> <span><?php echo $sub_title; ?></span></h4>
                           <ul>
                              <?php
                           ...
                           <?php   }
                              ...
                              if ($team_link) {
                                 ?>
                                    <li><a href="<?php echo $team_link; ?>"><i class="fa fa-linkedin"></i></a></li>
                             <?php }
                              ...
                              if ($team_goo) {
                                 ?>
                                  <li><a href="<?php echo $team_goo; ?>"><i class="fa fa-google-plus"></i></a></li>
                          <?php    }
